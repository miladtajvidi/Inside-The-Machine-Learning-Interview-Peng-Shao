<p align="center">
  <img src="./ml-peng.jpg" alt="Description of image" width="500" height="600">
</p>

# Inside-The-Machine-Learning-Interview-Peng-Shao

This repo contains the publicly available papers and articles cited in the [Inside the Machine Learning Interview: 151 Real Questions from FAANG and How to Answer Them]([https://www.susannalea.com/sla-title/pressure/](https://www.amazon.ca/Inside-Machine-Learning-Interview-Questions/dp/B0C4MVRHQD)) by Peng Shao.<br>
...
Please note that the hyperlink titles only include first author's name, title and the year published in order to make your search convenient. Please remember to cite them properly in your works.<br>
